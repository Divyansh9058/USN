...
document.addEventListener("DOMContentLoaded", () => {
  const contactTable = document.querySelector(
    ".main_admin_content_contact_table table tbody"
  );
  ...
  const handleStatusChange = async (event) => {
    ...
    try {
      const response = await fetch(
        `https://dark-pink-eagle-tux.cyclic.cloud/pdfdata/editpdfdata/${contactId}`,
        {
          method: "PATCH",
          headers: {
